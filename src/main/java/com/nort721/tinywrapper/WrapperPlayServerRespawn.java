...
public class WrapperPlayServerRespawn extends PacketWrapper {
    ...
    public WrapperPlayServerRespawn(PacketEvent packetEvent) {
    ...
    public Difficulty getDifficulty() {
        return packetData.getDifficulties().read(0);
    }
    ...
    public void setDifficulty(Difficulty value) {
        packetData.getDifficulties().write(0, value);
    }
    ...
    public NativeGameMode getGamemode() {
        return packetData.getGameModes().read(0);
    }
    ...
    public void setGamemode(NativeGameMode value) {
        packetData.getGameModes().write(0, value);
    }
    ...
    public WorldType getLevelType() {
        return packetData.getWorldTypeModifier().read(0);
    }
    ...
    public void setLevelType(WorldType value) {
        packetData.getWorldTypeModifier().write(0, value);
    }
